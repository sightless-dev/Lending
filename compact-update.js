...
const files = {
  // 1. Обновляем App.tsx (Убираем лишние секции)
...
export default function App() {
  ...
  // 2. Обновляем Header.tsx (Сокращаем меню)
...
export function Header() {
  ...
  // 3. Обновляем Hero.tsx (Добавляем LinkedIn)
...
export function Hero() {
      ...
      <div className="mx-auto w-[min(1200px,calc(100%-48px))] text-center relative z-10">
        ...
        <Reveal delay={0.18}>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            {/* Кнопка LinkedIn с крутым неоновым стилем */}
            <a href="https://www.linkedin.com/in/liubomyr-myshchenko-93413a3b2/" target="_blank" rel="noopener" className="group flex h-[44px] items-center gap-2.5 rounded-full border border-[#0A66C2]/40 bg-[#0A66C2]/10 px-6 text-[15px] font-semibold text-white transition-all hover:bg-[#0A66C2]/20 hover:shadow-[0_0_20px_rgba(10,102,194,0.3)]">
  ...
  // 4. Обновляем About.tsx (Сжимаем текст)
...
export function About() {
  ...
  // 5. Обновляем Experience.tsx (Убираем дубли цифр)
...
export function Experience() {
  ...
  // 6. Обновляем Contact.tsx (Добавляем LinkedIn вниз)
...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-[100px] pb-[120px]">
      <div className="mx-auto w-[min(800px,calc(100%-48px))] text-center">
        <Reveal>
        ...
        <Reveal delay={0.1}>
          <p className="mx-auto mb-8 text-[18px] leading-[1.65] text-white/65">
            {c.desc}
          </p>
        </Reveal>
...
console.log('\\n🎉 Сайт успешно сокращен, кнопки LinkedIn добавлены!');